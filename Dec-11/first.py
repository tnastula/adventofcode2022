def perform_task():
    ...
    rounds_to_perform = 20

    for _ in range(rounds_to_perform):
        for monkey in monkeys:
            movements = monkey.process_round()
    ...
    def process_round(self):
        ...
        for item in self.items:
            ...
            if item % self.test_factor == 0:
                movements.append((item, self.target_if_true))
            else:
                movements.append((item, self.target_if_false))
